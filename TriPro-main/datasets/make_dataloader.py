...
from datasets.AER_mm import AER_MM
...
def make_dataloader(cfg):
	...
	if cfg.DATASETS.NAMES != 'mars' and cfg.DATASETS.NAMES != 'prid' and cfg.DATASETS.NAMES != 'ilids' and cfg.DATASETS.NAMES != 'aer_mm' and cfg.DATASETS.NAMES != 'mars_mm'  :
...
def make_eval_all_dataloader(cfg):
	...
	if cfg.DATASETS.NAMES != 'mars' and cfg.DATASETS.NAMES != 'duke' and cfg.DATASETS.NAMES != 'lsvid' and cfg.DATASETS.NAMES != 'aer_mm' and cfg.DATASETS.NAMES != 'mars_mm'  :
